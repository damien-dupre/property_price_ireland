...
data_dublin_geocoded_clean %>% 
  ...
  stat_density_2d(
    ...
    geom = "polygon", 
    alpha = .2) +
  scale_x_continuous("Longitude", limits = c(-6.5,-6), breaks = seq(-6.5,-6,0.2)) +
  scale_y_continuous("Latitude", limits = c(53.2,53.5), breaks = seq(53.2,53.5,0.1)) +
...
```{r gam-plot,fig.width=5, fig.height=5, fig.cap="Prediction of property price according the GAM model. Prediction too far from the actual data were removed to avoid unrealistic extrapolation.", out.extra=''}
